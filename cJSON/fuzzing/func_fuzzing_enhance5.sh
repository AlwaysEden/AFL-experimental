mkdir -p afl-build-enhance5 || exit 1
cd afl-build-enhance5 || exit 1
#cleanup
rm -r -- *
...
program_pid0=$!
../../../../../afl-fuzz -i /mnt/hdd/fuzz_usability/AFL++experimental/cJSON/fuzzing/inputs -o ./ -R target.json ../afl-main @@ yes &
